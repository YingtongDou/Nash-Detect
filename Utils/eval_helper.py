...
def add_adversarial_review(user_product_graph, prod_user_graph, new_edges):
	...
	return [user_priors, review_priors, prod_priors, new_upriors, new_rpriors, new_ppriors], user_product_graph, prod_user_graph, user_ground_truth, review_ground_truth, new_added_reviews
